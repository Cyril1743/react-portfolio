...
export default function Contact() {
    ...
    return (
        <form className="d-flex m-auto flex-nowrap flex-column">
            ...
            <input className="form-control" id="name" type="text" placeholder="Your Name Here" onBlur={handleBlurName} onChange={handleChange} value={name}/>
            <label className="form-label" htmlFor="email">Email:</label>
            <input className="form-control" id="email" type="email" placeholder="Your Email Here" onBlur={handleBlurEmail} onChange={handleChange} value={email}/>
            <label className="form-label" htmlFor="message">Your Message:</label>
            <textarea className="form-control" id="message" placeholder="Your message here" value={message} onBlur={handleBlurMessage} onChange={handleChange}/>
